...
- [ ] Practica - Coding Dojo C# (TDD) - MarsRover
- [ ] Practica - Coding Dojo C# (TDD) - GlidedRose
- [ ] Practica - Coding Dojo Java o Python o Ruby (TDD) - Manejar una Pila Stack...
- [ ] Practica - Coding Dojo Java (TDD) - FizzBuzz + KataPotter
- [ ] Practica - Coding Dojo Python (TDD) - Numeros Romanos
- [ ] Practica - Coding Dojo Ruby (TDD) - PacMan
- [ ] Practica - Coding Dojo C++ (TDD) - Teorema de la vida de Conway
...
- [ ] Parctica - Vivir con Sonar, Jenkins y C#, y sobrevivir al final del dia...
